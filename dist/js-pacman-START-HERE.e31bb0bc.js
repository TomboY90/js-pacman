...
var GameBoard = /*#__PURE__*/function () {
  ...
  (0, _createClass2.default)(GameBoard, [{
    ...
    value: function createGrid(level) {
      ...
      level.forEach(function (squre) {
        var div = document.createElement('div');
        div.classList.add('square', _setup.CLASS_LIST[squre]);
        ...
        if (_setup.CLASS_LIST[squre] === _setup.OBJECT_TYPE.DOT) {
          _this.dotCount++;
        }
      });
    }
    ...
    value: function addObject(position, classes) {
      ...
      (_this$grid$position$c = this.grid[position].classList).add.apply(_this$grid$position$c, (0, _toConsumableArray2.default)(classes));
    }
  }, {
    key: "removeObject",
    value: function removeObject(position, classes) {
      ...
      (_this$grid$position$c2 = this.grid[position].classList).remove.apply(_this$grid$position$c2, (0, _toConsumableArray2.default)(classes));
    }
  }, {
    key: "isObjectExist",
    value: function isObjectExist(position, object) {
      return this.grid[position].classList.contains(object);
    }
  }, {
    key: "rotateDiv",
    value: function rotateDiv(position, degree) {
      this.grid[position].style.transform = "rotate(".concat(degree, "deg)");
    }
  }, {
    key: "resetGame",
